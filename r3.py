...
class CameraWidget(QWidget):
    ...
    def update_frame(self, frame):
        ...
        try:
            ...
            # Scale differently for fullscreen vs grid view
...
class MainWindow(QMainWindow):
    ...
    def show_fullscreen(self, camera_number):
        ...
        # Store the original parent and geometry for restoration
        self.original_parent = existing_widget.parent()
        self.original_geometry = existing_widget.geometry()

        # Hide all widgets immediately
        for widget in self.camera_widgets.values():
            widget.hide()

        # Set up fullscreen widget
        self.fullscreen_widget = existing_widget
        self.fullscreen_widget.setParent(None)  # Remove parent to avoid constraints
        self.fullscreen_widget.showFullScreen()  # Make it fullscreen
    ...
    def exit_fullscreen(self):
        ...
        # Hide fullscreen widget first
        self.fullscreen_widget.hide()
        
        # Restore original parent and geometry
        self.fullscreen_widget.setParent(self.original_parent)
        self.fullscreen_widget.setGeometry(self.original_geometry)
