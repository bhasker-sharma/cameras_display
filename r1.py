...
class CameraWidget(QWidget):
    ...
    def __init__(self, camera_number, base_app, parent=None):
        ...
        self.setFixedSize(320, 240)  # Fixed size for the entire widget
...
class MainWindow(QMainWindow):
    ...
    def create_camera_grid(self, rows, cols, start_index, count):
        ...
        # Set equal stretch factors for all rows and columns
        for i in range(rows):
    ...
    def show_fullscreen(self, camera_number):
        ...
        # Resize the fullscreen widget
        self.fullscreen_widget.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        self.fullscreen_widget.setFixedSize(640, 480)  # Larger fixed size for fullscreen
        
        # Create container layout for proper centering
        fullscreen_container = QWidget()
        container_layout = QVBoxLayout(fullscreen_container)
        container_layout.setAlignment(Qt.AlignCenter)
        container_layout.addWidget(self.fullscreen_widget)
        
        # Add to content layout
        self.content_layout.addWidget(fullscreen_container)
    ...
    def exit_fullscreen(self):
        ...
        if self.fullscreen_widget:
            ...
            self.fullscreen_widget.setParent(None)
